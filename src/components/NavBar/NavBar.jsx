...
export default function PrimarySearchAppBar() {
  ...
  const renderMenu = (
    ...
    >
      {!localStorage.getItem("auth-token") ? (
        ...
        <div>
          <Link to={`/profile/${localStorage.getItem("auth-token")}`}>
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      ...
      <AppBar
        position="sticky"
        sx={{ minheight:"10vh",maxheight:"10vh", overflow: "none", zIndex: "10" }}
      >
